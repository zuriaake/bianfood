...
$cat = isset($_REQUEST['cat']) && isset($cat_page_array[$_REQUEST['cat']]) ? $_REQUEST['cat'] : 'company';
$current_cat = $cat_page_array[$cat];
...
if (!$smarty->is_cached('news_list.dwt', $cache_id))
{
    /* 如果页面没有被缓存则重新获得页面的内容 */
...
$smarty->assign('cat_list',    $cat_page_array);
$smarty->assign('current_cat',    $current_cat);
$smarty->display('news_list.dwt', $cache_id);
